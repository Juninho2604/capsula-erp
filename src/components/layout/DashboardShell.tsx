        ...
        return (
            <div className="h-screen w-screen overflow-hidden bg-background">
                ...
                <button
                    ...
                    className="fixed bottom-4 right-4 z-[80] inline-flex items-center gap-1.5 rounded-full bg-capsula-coral hover:bg-capsula-coral-hover px-3.5 py-2 text-xs font-semibold text-white shadow-cap-raised backdrop-blur-sm transition-all"
                >
