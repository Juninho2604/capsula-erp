...
import { CapsulaLogoHero } from '@/components/ui/CapsulaLogo';
...
export default async function LoginPage() {
    ...
    return (
        <div className="flex min-h-screen flex-col items-center justify-center bg-capsula-warm px-4 py-8 dark:bg-background sm:px-6 lg:px-8">
            <div className="w-full max-w-md space-y-8 rounded-2xl bg-white p-8 shadow-xl ring-1 ring-gray-900/5 dark:bg-gray-800 dark:ring-white/10">
                <div className="flex flex-col items-center">
                    <CapsulaLogoHero />
                    <h2 className="mt-6 text-center text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white font-heading">
                        Iniciar Sesión
                    </h2>
