                    ...
                    >
                        ...
                        <div className="mb-4 flex items-start justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="font-heading text-lg tracking-[-0.01em] text-capsula-ink">{loan.loaneeName}</h3>
            ...
            {showResolveModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm">
                    <div className="w-full max-w-md rounded-xl bg-white p-6 shadow-xl dark:bg-gray-800 animate-in fade-in zoom-in-95">
                        <h3 className="mb-4 text-lg font-heading text-lg tracking-[-0.01em] text-capsula-ink">Confirmar Resolución</h3>
