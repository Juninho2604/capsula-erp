...
export const MODULE_REGISTRY: ModuleDefinition[] = [
  ...
  },
  {
    id: 'subrecetas',
    label: 'Sub-recetas',
    description: 'Salsas, masas, aderezos y preparaciones intermedias',
    icon: '📋',
    href: '/dashboard/subrecetas',
    section: 'operations',
    enabledByDefault: true,
    sortOrder: 61,
  },
  ...
  },
  {
    ...
    description: 'Precios por canal (delivery, wink, restaurante): crear, activar y editar',
    icon: '🏷️',
    href: '/dashboard/menu/listas-precios',
    section: 'operations',
    enabledByDefault: true,
    requiresFeatureFlag: 'priceListsEnabled',
    sortOrder: 118,
  },
  {
    id: 'clientes',
  ...
  },
  {
    id: 'reportes',
    label: 'Reportes',
    description: 'Dashboard ejecutivo y reportes por familia: ventas, operativos, inventario, compras, gerencial y fiscal. Exportables a Excel/PDF.',
    icon: '📑',
    ...
    subRoutes: [
      ...
      '/dashboard/reportes/compras',
      '/dashboard/reportes/gerencial',
      '/dashboard/reportes/fiscal',
  ...
  },
  {
    id: 'proveedores',
    label: 'Proveedores',
    description: 'Registro de proveedores (RIF, contacto) — se reflejan en Documentos, Cuentas por pagar y anticipos',
    icon: '🏢',
    href: '/dashboard/proveedores',
    section: 'admin',
    enabledByDefault: true,
    sortOrder: 575,
    tags: ['proveedores', 'suppliers', 'acreedores', 'compras'],
  },
  {
    id: 'cuentas_pagar',
  ...
  },
  {
    ...
    description: 'Registro de cambios entre monedas: salida de $ o Bs e ingreso a las cuentas bancarias destino',
    icon: '💱',
    href: '/dashboard/cambio-divisas',
    section: 'admin',
    enabledByDefault: true,
    sortOrder: 586,
    tags: ['cambio', 'divisas', 'monedas', 'tesorería', 'bancos', 'tasa'],
  },
  {
    id: 'conciliacion',
    label: 'Conciliación',
...
export const MODULE_ROLE_ACCESS: Record<string, string[]> = {
  ...
  subrecetas: ['OWNER', 'AUDITOR', 'ADMIN_MANAGER', 'OPS_MANAGER', 'CHEF'],
  ...
  price_lists: ['OWNER', 'ADMIN_MANAGER', 'OPS_MANAGER'],
