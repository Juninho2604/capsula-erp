    ...
    "modules": [
            ...
            "tasks": [
                {
                    ...
                    "steps": [
                        ("Entra al módulo Juegos.", "Ruta <span class='pill'>/dashboard/games</span>, en el grupo de Entretenimiento del menú lateral."),
                        ("Elige una estación en estado <span class='pill'>Disponible</span>.", "Si la estación está en uso, reservada o en mantenimiento, el sistema no deja abrir la sesión y te dice el estado."),
                        ("Carga los datos del cliente.", "Nombre (opcional — por defecto <em>Cliente</em>) y cantidad de personas."),
                        ("Elige cómo se factura.", "Por hora, por pulsera o monto fijo. Por hora es el modo por defecto."),
                        ("Confirma el inicio.", "La estación pasa a <span class='pill'>En Uso</span>, la sesión aparece en <strong>Sesiones activas</strong> con su tiempo corriendo, y queda registrado quién la abrió."),
                    ],
                },
                {
                    ...
                    "steps": [
                        ("Ubica la sesión activa de la estación.", "En la grilla de Juegos o en el panel <strong>Sesiones activas</strong>. La tarjeta ya muestra el tiempo transcurrido y el monto aproximado."),
                        ("Cierra la sesión.", "El sistema toma la hora de cierre y cuenta los minutos jugados (el minuto empezado se cuenta completo)."),
                        ("Revisa el monto calculado.", "Minutos jugados ÷ 60 × tarifa por hora de la estación. Ese es el total a cobrar."),
                        ("Cobra al cliente.", "El monto entra en el <strong>Facturado hoy</strong> del módulo y la sesión queda en el historial con quién la abrió y quién la cerró."),
                ...
                },
                {
                    ...
                    "steps": [
                        ("Consulta los planes en Pulseras.", "Ruta <span class='pill'>/dashboard/wristbands</span>. Cada plan tiene precio y duración definidos — eso es lo que se le cobra al cliente."),
                        ("Cobra el precio del plan y entrega la pulsera.", "El color del plan ayuda a distinguir de un vistazo qué pulsera lleva cada cliente."),
                        ("Inicia la sesión con facturación por pulsera.", "Al abrir la sesión en Juegos, elige el modo pulsera y registra el código de la pulsera entregada."),
                ...
                },
                {
                    ...
                    "steps": [
                        ("Pausa la sesión activa.", "La sesión queda en pausa pero sigue viva: no se cierra ni se cobra nada todavía."),
                        ("Reanuda cuando el cliente vuelva.", "La sesión vuelve a estado activo y se cierra después de la forma normal."),
                    ],
                },
            ],
            "callouts": [
            ...
            "tasks": [
                {
                    ...
                    "steps": [
                        ("Entra a Reservaciones.", "Ruta <span class='pill'>/dashboard/reservations</span>."),
                        ("Carga el cliente y la estación.", "Nombre (obligatorio), teléfono si lo tienes, cantidad de personas y la estación que quiere."),
                        ("Define el horario.", "Hora de inicio y de fin. Si otra reserva ocupa ese rango en la misma estación, el sistema lo rechaza y te dice con cuál choca."),
                        ("Agrega depósito o plan de pulsera si aplica.", "El depósito queda marcado como pagado o pendiente; el plan de pulsera define cómo se facturará la sesión."),
                        ("Guarda.", "La reserva nace en <span class='pill'>Pendiente</span> y aparece en la lista del día."),
                    ],
                },
                {
                    "title": "Confirmar o cancelar una reserva",
                    "steps": [
                        ("Confirma cuando el cliente ratifica.", "La reserva pasa de <span class='pill'>Pendiente</span> a <span class='pill'>Confirmada</span>."),
                        ("Cancela si el cliente desiste.", "Puedes dejar anotado el motivo. La reserva queda <span class='pill'>Cancelada</span> y libera el horario de la estación."),
                    ],
                },
                {
                    ...
                    "steps": [
                        ("Ubica la reserva del cliente en la lista de hoy.", "Debe estar en <span class='pill'>Pendiente</span> o <span class='pill'>Confirmada</span>."),
                        ("Haz el check-in.", "La reserva pasa a <span class='pill'>Check-in</span> y el sistema abre la sesión de juego automáticamente en la estación reservada."),
        ...
        # ====================================================================
        {
            ...
            "what":
                ...
                "vistazo. Los planes creados aquí se vinculan a las reservas y a las sesiones de "
            ...
            "tasks": [
                {
                    ...
                    "steps": [
                        ("Entra a Pulseras.", "Ruta <span class='pill'>/dashboard/wristbands</span>. Es un módulo de gerencia: la cajera no crea planes."),
                        ("Define código, nombre y duración.", "La duración va en minutos de juego (la pantalla la muestra como horas y minutos)."),
                        ("Pon el precio y el color.", "El precio es lo que se cobra al vender la pulsera; el color identifica la pulsera física."),
                        ("Limita las estaciones si hace falta.", "El máximo de sesiones simultáneas del plan es opcional."),
                        ("Guarda.", "El plan queda disponible para vincular en reservas y sesiones."),
                    ],
                },
                {
                    "title": "Editar o retirar un plan",
                    "steps": [
                        ("Abre el plan y cambia lo que necesites.", "Nombre, duración, precio, color o máximo de estaciones."),
            ...
            "tasks": [
                {
                    ...
                    "steps": [
                        ("Entra a Cola de Espera.", "Ruta <span class='pill'>/dashboard/queue</span>."),
                        ("Carga el cliente.", "Nombre, teléfono si lo da, cantidad de personas y — si la pide — la estación o tipo de juego que quiere."),
                        ("Entrega el número de turno.", "El sistema asigna el siguiente número del día y calcula la espera estimada. El cliente queda <strong>En Espera</strong>."),
                    ],
                },
                {
                    "title": "Llamar al siguiente y sentarlo",
                    "steps": [
                        ("Cuando se libera una estación, llama al primer turno.", "El ticket pasa a <strong>Llamado</strong> y sube al bloque destacado de la pantalla con la hora del llamado."),
                        ("Cuando el cliente se presenta, marca el turno como sentado.", "El turno sale de la cola y el cliente arranca su sesión en <span class='pill'>Juegos</span>."),
                    ],
                },
                {
                    "title": "Expirar o cancelar un turno",
                    "steps": [
                        ("Si el llamado no se presenta, marca el turno como expirado.", "Libera el lugar para el siguiente en la cola."),
                        ("Si el cliente desiste antes del llamado, cancela el turno.", "El ticket sale de la cola sin afectar a los demás."),
                    ],
                },
            ],
        },
