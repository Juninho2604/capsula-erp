    ...
    "modules": [
        ...
        # ════════════════════════════════════════════════════════════════════
        {
            ...
            "what":
                ...
                "módulo más importante del sistema — por acá pasa cada bolívar y cada dólar que "
            ...
            "tasks": [
                {
                    ...
                    "steps": [
                        ("Tocá una mesa libre en el plano.", "Se abre el modal <span class='pill'>Abrir cuenta</span> con el nombre de la mesa."),
                        ("Cargá el nombre del cliente (opcional) y el número de personas.", "También podés elegir el <strong>mesonero asignado</strong> de la lista, o dejarlo en «— Ninguno —»."),
                        ("Confirmá con <span class='pill'>Abrir cuenta</span>.", "La mesa pasa a ocupada, la cuenta recibe su código (tabCode) y ya podés agregar productos."),
                        ("Para un pedido de mostrador, usá <span class='pill'>Nuevo Pickup</span>.", "Está en el panel <span class='pill'>Pickup / Para llevar</span>. Cada pickup recibe su número del día (PK-01, PK-02…) y podés tener varios abiertos a la vez, cada uno con su carrito."),
                    ],
                    "callouts": [
                        ("info", "Cuentas del mesero", "Si la mesa la abrió un mesonero desde el POS Mesero, acá la ves igual: con su consumo, su mesonero y sus subcuentas si las creó. La caja solo cobra."),
                    ],
                },
                {
                    ...
                    "steps": [
                        ("Tocá el producto en el menú.", "Si tiene modificadores (extras, opciones, «sin» ingredientes), se abre su ventana para elegirlos; los obligatorios no dejan continuar sin completar."),
                        ("Ajustá cantidad, <span class='pill'>Notas</span> y <span class='pill'>Para llevar</span> si aplica.", "La nota viaja a cocina tal como la escribís."),
                        ("Tocá <span class='pill'>Agregar consumo a la cuenta →</span>.", "Los productos del carrito se suman a la cuenta abierta y la comanda sale hacia cocina y barra según la categoría de cada producto — la comida a cocina, las bebidas a barra."),
                    ],
                    "callouts": [
                        ("info", "Ruteo automático", "No elegís a dónde va cada ítem: el sistema lo decide por la categoría del producto, ya configurada en el menú."),
                    ],
                },
                {
                    ...
                    "steps": [
                        ("Tocá <span class='pill'>Dividir cuenta (subcuentas)</span> en la cuenta activa.", "Entra al panel de subcuentas. Si el mesonero ya las creó, el POS entra solo a este modo."),
                        ("Creá las subcuentas o usá <span class='pill'>División rápida</span>.", "Los botones 2 / 3 / 4 / 5 / 6 reparten los ítems en partes iguales; también podés crear subcuentas con nombre y asignar ítem por ítem (incluso cantidades parciales)."),
                        ("Cobrá cada subcuenta con su propio botón <span class='pill'>Cobrar</span>.", "Cada una con su método de pago, su servicio y su descuento. El panel muestra las <strong>subcuentas cobradas</strong> y el <strong>saldo restante</strong> de la mesa."),
                ...
                },
                {
                    ...
                    "steps": [
                        ("Tocá <span class='pill'>Pre-cuenta</span> en la cuenta activa.", "Imprime el consumo a monto pleno, sin descuentos."),
                        ("Si el cliente va a pagar en divisas, usá <span class='pill'>Pre-cuenta c/ desc divisas</span>.", "Imprime la misma cuenta pero con el descuento por pago en divisas ya aplicado, para que el cliente vea cuánto pagaría en efectivo o Zelle."),
                    ],
                    "callouts": [
                ...
                },
                {
                    ...
                    "steps": [
                        ("En <span class='pill'>1. Descuento</span> elegí cómo va la cuenta.", "<span class='pill'>Normal</span> (sin descuento), el botón de <strong>descuento por divisas</strong> (solo se habilita si el pago es en efectivo $ / € o Zelle) o <span class='pill'>Cortesía (PIN)</span> — total o parcial, siempre con PIN de gerente."),
                        ("Revisá el bloque <span class='pill'>Servicio</span>.", "Por defecto aplica 10%, editable en el momento (accesos rápidos 10 / 12 / 15 / 20%). <span class='pill'>Quitar</span> lo exime, pero pide <strong>PIN de capitán o gerente</strong>."),
                        ("En <span class='pill'>2. Forma de pago</span> elegí el método con <span class='pill'>Pago único</span>.", "Cash $, Cash €, Zelle, Efectivo Bs, PDV o Pago Móvil. Los métodos en bolívares convierten con la tasa del día."),
                        ("Ingresá el monto recibido si es efectivo.", "El sistema calcula y muestra el vuelto. Si el cliente deja de más, usá <span class='pill'>Registrar como propina</span>."),
                        ("Tocá <span class='pill'>Cobrar cuenta</span> e ingresá el <span class='pill'>PIN de cajera / gerente</span>.", "Se muestra el resumen y confirmás con <span class='pill'>Confirmar pago</span>. El PIN se valida al cobrar: si es inválido, el cobro se rechaza y volvés a la pantalla."),
                ...
                },
                {
                    ...
                    "steps": [
                        ("Cambiá el selector a <span class='pill'>Pago mixto</span>.", "Aparece la lista de líneas de pago: agregás cada método con su monto."),
                        ("Cargá las líneas hasta cubrir el total.", "El panel marca <strong>Pendiente</strong> mientras falte y <strong>Completado</strong> al llegar al monto exacto; también calcula el vuelto si el efectivo se pasa."),
                        ...
                        ("Cobrá igual que en pago simple.", "<span class='pill'>Cobrar cuenta</span>, PIN y <span class='pill'>Confirmar pago</span>. Cada línea queda registrada por separado en el arqueo."),
                    ],
                    "callouts": [
                ...
                },
                {
                    ...
                    "steps": [
                        ...
                        ("Para un cobro puntual de subcuenta, tocá <span class='pill'>Ajustar %</span>.", "Aparece en el aviso de descuento de la subcuenta. Se abre un modal con el porcentaje nuevo y el <strong>PIN de gerente</strong>; muestra en vivo cuánto queda el descuento y el neto antes de confirmar."),
                ...
                },
                {
                    ...
                    "steps": [
                        ("Tocá el ítem enviado que querés corregir.", "Podés elegir <span class='pill'>Anular ítem</span>, <span class='pill'>Ajustar cantidad</span> o cambiarlo por otro producto."),
                        ("Escribí el motivo e ingresá el PIN.", "Los dos campos son obligatorios — sin motivo y PIN el botón no se habilita."),
                        ("Para tirar toda la comanda, usá <span class='pill'>Anular comanda completa</span>.", "Anula TODOS los ítems de esa comanda de una vez con un solo <span class='pill'>PIN de capitán o gerente</span>. El inventario se reintegra automáticamente y la anulación se imprime en cocina/barra para que dejen de prepararla."),
                    ],
                    "callouts": [
            ...
            "tasks": [
                {
                    ...
                    "steps": [
                        ("Abrí el POS Mesero.", "Ruta <span class='pill'>/dashboard/pos/mesero</span>. Aparece el teclado numérico con la lista de mesoneros activos."),
                        ("Ingresá tu PIN.", "El sistema te reconoce y tu nombre queda asociado a todo lo que hagas en el turno."),
                    ],
                    "callouts": [
                ...
                },
                {
                    ...
                    "steps": [
                        ("Tocá una mesa libre.", "Se abre el modal <span class='pill'>Abrir cuenta</span> con el nombre de la mesa."),
                        ("Cargá <strong>nombre del cliente</strong> y <strong>teléfono</strong>.", "Acá los dos son obligatorios — sin ellos el botón no se habilita. También indicás el número de personas."),
                        ("Confirmá con <span class='pill'>Abrir cuenta</span>.", "La mesa pasa a ocupada con vos como <strong>mesonero de la mesa</strong> y ya podés cargar el pedido."),
                    ],
                },
                {
                    "title": "Agregar productos y enviar a cocina",
                    "steps": [
                        ("Elegí los productos del menú por categorías.", "Con sus extras, modificadores y notas si el producto los tiene."),
                        ("Revisá el pedido en el panel de la derecha.", "Verificá cantidades y notas antes de marchar."),
                        ("Tocá <span class='pill'>Enviar a cocina</span>.", "La comida va a la comandera de cocina y las bebidas a la de barra, automáticamente."),
                        ("Si hay entradas y principales, marchá por tiempos.", "Aparecen los botones <span class='pill'>Entradas</span> y <span class='pill'>Principales</span> para enviar cada tanda por separado, o <span class='pill'>Marchar todo</span> para enviar todo junto."),
                    ],
                    "callouts": [
                        ("info", "Sin conexión", "Si se cae la señal, la orden queda guardada en el carrito de la mesa — tocás <span class='pill'>Enviar a cocina</span> de nuevo cuando vuelva y sale sin duplicarse."),
                    ],
                },
                {
                    "title": "Mostrar la cuenta al cliente",
                    "steps": [
                        ("Tocá <span class='pill'>Mostrar cuenta al cliente</span>.", "Muestra el consumo, el servicio y el total en USD con su equivalente en Bs a la tasa del día."),
                        ("Avisá a la caja para el cobro.", "El cobro y el cierre de la mesa los hace la cajera en el POS Restaurante, no el mesonero."),
                    ],
                },
                {
                    "title": "Dividir la cuenta o transferir la mesa (capitanes)",
                    "steps": [
                        ("Usá <span class='pill'>Dividir cuenta (subcuentas)</span>.", "Solo visible para capitanes. Reparte el consumo en subcuentas que después la caja cobra por separado."),
                        ("Usá <span class='pill'>Transferir mesa</span> para cambiar de mesonero.", "La transferencia pide <strong>PIN de capitán o gerente</strong> y queda registrada."),
                    ],
                },
            ],
        },
        ...
        # ════════════════════════════════════════════════════════════════════
        {
            ...
            "features": [
                ("Clientes recurrentes", "Buscá por cédula, nombre o teléfono y la ficha se completa sola con la dirección conocida."),
                ...
                ("Lector de WhatsApp", "Pegás el mensaje del cliente y el sistema arma el pedido."),
            ...
            "tasks": [
                {
                    ...
                    "steps": [
                        ("Buscá primero si el cliente ya existe.", "Campo <span class='pill'>Buscar cliente recurrente por cédula, nombre o teléfono…</span> — si aparece, sus datos se cargan solos."),
                        ("Si es nuevo, completá <strong>nombre</strong>, <strong>teléfono</strong> y la <strong>dirección exacta de entrega</strong>.", "El teléfono enlaza el pedido a la ficha del cliente para la próxima vez."),
                ...
                },
                {
                    ...
                    "steps": [
                        ("Agregá los productos del menú.", "Igual que en los otros POS: categorías, modificadores y notas."),
                        ("En el bloque <span class='pill'>Envío</span> elegí la zona.", "<span class='pill'>Normal</span> o <span class='pill'>Cercano</span> — cada botón muestra su tarifa vigente."),
                        ("En <span class='pill'>¿Cómo lo cobras?</span> elegí la moneda del envío.", "<span class='pill'>Dólares</span> o <span class='pill'>Bolívares</span>. El monto es el mismo en los dos botones: la moneda solo decide en qué se cobra (en Bs se convierte con la tasa del día)."),
                    ],
                    "callouts": [
                ...
                },
                {
                    ...
                    "steps": [
                        ("Elegí descuento y método de pago.", "<span class='pill'>Normal</span> o el descuento por divisas (solo con Cash $, Cash € o Zelle); cortesía con PIN de gerente. Podés cobrar con un método o en pago mixto."),
                        ...
                        ("Tocá <span class='pill'>Confirmar orden</span>.", "Se muestra el resumen del pago, confirmás, y la comanda sale a cocina/barra con los datos del cliente y la hora si la hay."),
                    ],
                },
                {
                    "title": "Cargar un pedido pegado desde WhatsApp",
                    "steps": [
                        ("Abrí el lector de pedidos de WhatsApp.", "Pegás el mensaje tal como lo mandó el cliente."),
                        ("Revisá lo que el sistema reconoció.", "Productos, cantidades y datos del cliente — corregí lo que haga falta antes de confirmar."),
                    ],
                },
            ],
        },
        ...
        # ════════════════════════════════════════════════════════════════════
        {
            ...
            "who": "Cajera y gerencia",
            "what":
                "Registro de las órdenes que entran por la plataforma PedidosYA. Acá se carga el "
            ...
            "tasks": [
                {
                    ...
                    "steps": [
                        ("Agregá los productos del pedido.", "Menú por categorías, con cantidad y <span class='pill'>Notas</span> por producto."),
                        ("Revisá el <span class='pill'>Total estimado</span>.", "Es referencial — lo que la plataforma cobra al cliente lo maneja PedidosYA."),
                        ("Registrá el pedido.", "La comanda sale a cocina/barra y la venta queda en el historial marcada con su canal."),
                    ],
                },
                {
                    "title": "Ver lo vendido por este canal",
                    "steps": [
                        ("Entrá a <span class='pill'>Historial Ventas</span> y filtrá por tipo PedidosYA.", "El Reporte Z y el resumen de cierre también separan este canal en su propio renglón."),
                    ],
                },
            ],
        },
            ...
            "tasks": [
                {
                    ...
                    "steps": [
                        ("Agregá los productos con su cantidad y notas.", "Los precios que ves ya son los del canal: el precio WINK si existe, el del menú si no."),
                        ("Tocá <span class='pill'>Registrar pedido</span>.", "La comanda sale a cocina/barra con su número y la venta queda registrada en el canal WINK."),
                    ],
                },
                {
                    "title": "Reimprimir la última comanda",
                    "steps": [
                        ("Tocá <span class='pill'>Reimprimir comanda</span>.", "Aparece debajo del botón de registro, con el número del último pedido. Útil si la impresora falló o cocina perdió el papel."),
                    ],
                },
            ],
        },
        ...
        # ════════════════════════════════════════════════════════════════════
        {
            ...
            "what":
                ...
                "correcciones. La venta cargada acá entra a los mismos reportes que las del POS, "
            ...
            "features": [
                ...
                ("Mismos descuentos que el POS", "El descuento por divisas usa el porcentaje configurado — la misma venta da el mismo monto acá y en el POS."),
            ...
            "tasks": [
                {
                    ...
                    "steps": [
                        ("Armá el pedido desde el bloque <span class='pill'>Menú</span>.", "Agregá los productos con sus cantidades, como en un POS."),
                        ("Elegí el tipo de venta.", "<span class='pill'>Mesa</span>, <span class='pill'>Delivery</span> o <span class='pill'>Para llevar</span>, con su método de pago y descuento si corresponde."),
                        ("Revisá subtotal, descuento y total, y tocá <span class='pill'>Registrar Venta</span>.", "La venta queda en el historial del día y descuenta inventario igual que una venta de POS."),
                    ],
                },
                {
                    "title": "Revisar lo cargado hoy",
                    "steps": [
                        ("Mirá la tabla del día.", "Columnas Orden, Tipo, Cliente, Items, Total, Hora y Acciones."),
                        ("Verificá contra los totales de arriba.", "Ventas Hoy e Ingresos Hoy deben cuadrar con lo que acabás de cargar."),
                    ],
                },
            ],
        },
        ...
        # ════════════════════════════════════════════════════════════════════
        {
            ...
            "what":
                ...
                "externos y de la carga manual. De acá salen el <strong>Reporte Z</strong> (cierre "
            ...
            "tasks": [
                {
                    ...
                    "steps": [
                        ("Elegí la fecha y usá <span class='pill'>Buscar</span>.", "Por número de orden, cliente o monto."),
                        ("Combiná los filtros <span class='pill'>Método</span> y <span class='pill'>Tipo</span>.", "Por ejemplo: solo Zelle de delivery, o solo ventas <span class='pill'>Con descuento</span> del día."),
                    ],
                },
                {
                    "title": "Sacar el Reporte Z y el cierre del día",
                    "steps": [
                        ("Elegí la fecha y tocá <span class='pill'>Reporte Z</span>.", "Agrupa por método de pago, muestra el <strong>TOTAL COBRADO</strong>, el total en Bs con la tasa, el arqueo de caja y las anulaciones del día."),
                        ("Tocá <span class='pill'>Cierre del día</span> para el resumen ejecutivo.", "Ventas por canal, descuentos, servicio y el desglose Divisas (Cash / Zelle) vs Bolívares (PDV / Móvil)."),
                        ("Usá <span class='pill'>Exportar Excel</span> para el arqueo.", "Es la base del cuadre de caja del turno."),
                    ],
                },
                {
                    "title": "Anular una venta cobrada",
                    "steps": [
                        ("Ubicá la venta y abrí <span class='pill'>Anular Venta</span>.", "El modal muestra cliente, cajera, ítems y total cobrado antes de confirmar."),
                        ("Ingresá el <span class='pill'>PIN de Autorización</span>.", "Solo autorizan los roles de gerencia (y Jefe de Área). La venta queda marcada como anulada — no se borra — y aparece en el bloque de auditoría del Reporte Z."),
                    ],
                    "callouts": [
            ...
            "tasks": [
                {
                    ...
                    "steps": [
                        ("Elegí el rango de fechas.", "El reporte se arma con las ventas cobradas del período."),
                        ("Filtrá por canal y categoría si querés afinar.", "Por ejemplo: solo Delivery, solo bebidas."),
                        ("Leé la tabla.", "Unidades e ingresos por producto, con su precio promedio real (ya con descuentos)."),
                    ],
                },
                {
                    "title": "Usarlo para producción y menú",
                    "steps": [
                        ("Compará semanas equivalentes.", "Las unidades por plato marcan qué producir y cuánto."),
                        ("Cruzá con <span class='pill'>Margen por Plato</span>.", "Lo más vendido no siempre es lo más rentable — las dos vistas juntas cuentan la historia completa."),
                    ],
                },
            ],
        },
        ...
        # ════════════════════════════════════════════════════════════════════
        {
            ...
            "features": [
                ...
                ("Solo comida", "Las bebidas no aparecen acá: cada estación ve lo suyo."),
            ...
            "tasks": [
                {
                    ...
                    "steps": [
                        ("Abrí la comandera.", "Ruta <span class='pill'>/kitchen</span>. El encabezado muestra las órdenes pendientes."),
                        ("Prepará lo que va llegando.", "Cada tarjeta trae los ítems con sus notas, el mesonero y la mesa o el canal."),
                        ("Marcá la orden con <span class='pill'>LISTO PARA ENTREGAR</span> al terminarla.", "Desaparece de pendientes y el salón sabe que el plato salió."),
                    ],
                },
                {
            ...
            "tasks": [
                {
                    ...
                    "steps": [
                        ("Abrí la comandera de barra.", "Ruta <span class='pill'>/kitchen/barra</span>, pantalla completa."),
                        ("Prepará y marcá cada orden como lista al salir.", "Desaparece de pendientes, igual que en cocina."),
                    ],
                },
                {
                    "title": "Si no aparece una bebida",
                    "steps": [
                        ("Verificá la categoría del producto en el <span class='pill'>Menú</span>.", "El ruteo a barra depende de la categoría: si el producto está en una categoría de comida, la orden salió por cocina."),
                    ],
                },
            ],
        },
        ...
        # ════════════════════════════════════════════════════════════════════
        {
            ...
            "what":
                ...
                "<strong>costo de envío del delivery por zona</strong>. Lo que se cambia acá "
            ...
            "tasks": [
                {
                    ...
                    "steps": [
                        ("Entrá a Configuración POS.", "Ruta <span class='pill'>/dashboard/config/pos</span>."),
                        ("En <span class='pill'>Descuento por pago en divisas</span>, cargá el <span class='pill'>Porcentaje de descuento</span>.", "La pantalla muestra el descuento actual. El valor aplica a todos los POS y a los rótulos de los reportes — nadie escribe el número a mano en ninguna pantalla."),
                    ],
                    "callouts": [
                ...
                },
                {
                    ...
                    "steps": [
                        ("Andá a la sección <span class='pill'>Costo de envío del delivery</span>.", "Dos campos: <span class='pill'>Envío normal</span> y <span class='pill'>Envío cercano</span> (por defecto $3 y $1)."),
                        ("Guardá los montos.", "El POS Delivery muestra las nuevas tarifas de inmediato en su selector de zona. La moneda en que se cobra el envío no cambia el monto — solo lo convierte a Bs con la tasa del día."),
                    ],
                },
                {
                    "title": "Ajustar impresión y validación de stock",
                    "steps": [
                        ("Revisá los interruptores de impresión.", "<span class='pill'>Imprimir comanda cocina al confirmar</span>, <span class='pill'>Imprimir comanda cocina al enviar a mesa</span>, <span class='pill'>Imprimir factura al registrar pago (cerrar cuenta)</span> y la impresión por impresora de red (agente)."),
                        ("Activá <span class='pill'>Validar stock antes de confirmar orden</span> si querés el candado.", "Con esto encendido, un producto sin existencias no se puede vender desde el POS."),
                    ],
                },
            ],
        },
