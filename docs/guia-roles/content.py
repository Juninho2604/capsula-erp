...
INTRO = {
    "how_to_read":
        ...
        "con las tareas que hace todos los días, explicadas paso a paso. No necesitás leerla "
        "completa — andá directo a tu rol. Si querés entender el sistema en general, empezá por "
    ...
    "login_steps": [
        ("Abrí KPSULA en el navegador o la app instalada.", "Aparece la pantalla de inicio de sesión."),
        ("Ingresá tu correo y contraseña.", "Son los que te asignó el administrador. La contraseña tiene mínimo 6 caracteres."),
        ("Entrás al sistema.", "Vas directo a tu pantalla principal. El menú lateral (sidebar) muestra solo tus módulos."),
    ],
    "login_note":
    ...
    "sidebar_note":
        ...
        "instalación, que tu rol tenga permiso, y que esté dentro de tu lista personal (si tenés "
        "una asignada). Por eso dos personas con el mismo cargo pueden ver pantallas distintas.",

    "roles_map":
        "El sistema tiene 10 roles. El número de nivel indica el alcance de acceso: a mayor "
    ...
    "glossary":
        "Términos que vas a leer en toda la guía y en las pantallas del sistema. Tenelos a mano "
    ...
    "payment_rules": [
        ("info", "Tasa del día", "Los métodos en bolívares (Efectivo Bs, PDV, Pago Móvil) usan la tasa cargada en <span class='pill'>Tasa de cambio</span>. Si la tasa no está actualizada, avisá a administración antes de cobrar."),
...
ROLES = [
    # ---------------------------------------------------------------- OWNER
    {
        ...
        "tasks": [
            {"title": "Activar o desactivar un módulo",
             ...
             "steps": [
                ("Entrá a Configuración → Módulos.", "Ruta <span class='pill'>/dashboard/config/modules</span>. Solo aparece para vos."),
                ("Revisá el catálogo de módulos.", "Cada módulo muestra su nombre, categoría y un interruptor de encendido."),
                ("Encendé o apagá los que quieras.", "El cambio afecta a toda la instalación de inmediato."),
                ("Guardá.", "La lista de módulos activos queda registrada en la configuración del sistema."),
             ],
            ...
            {"title": "Cargar la tasa de cambio del día",
             ...
             "steps": [
                ("Entrá a Configuración → Tasa de cambio.", "Ruta <span class='pill'>/dashboard/config/tasa-cambio</span>."),
                ("Ingresá la tasa Bs/USD y la fecha de vigencia.", "Es el valor del dólar que usará el POS."),
                ("Guardá.", "Desde ese momento, cada venta toma esta tasa y la deja registrada en el comprobante."),
             ],
            ...
            {"title": "Ver costos y rentabilidad",
             ...
             "steps": [
                ("Entrá a Costos o Margen por Plato.", "Bajo Operaciones."),
                ("Revisá el margen.", "El sistema calcula precio de venta menos costo de receta, ordenado por rentabilidad."),
             ]},
        ],
    ...
    # ------------------------------------------------------------- AUDITOR
    {
        ...
        "tasks": [
            {"title": "Hacer una auditoría de inventario",
             ...
             "steps": [
                ("Entrá a Inventario → Auditorías y creá una nueva.", "El sistema toma una foto del stock actual por ítem."),
                ("Contá físicamente y cargá las cantidades reales.", "Ítem por ítem; el sistema muestra la diferencia contra lo esperado."),
                ("Aprobá la auditoría.", "Por cada diferencia genera un ajuste automático (entrada o salida) y corrige el stock."),
             ],
            ...
            {"title": "Revisar reportes",
             ...
             "steps": [
                ("Entrá al módulo que quieras revisar.", "Finanzas, Historial de Ventas, Gastos, Caja…"),
                ("Filtrá por fecha o período.", "Los datos son de solo consulta: podés analizar y exportar, pero no editar."),
             ]},
        ],
    ...
    # ------------------------------------------------------- ADMIN_MANAGER
    {
        ...
        "tasks": [
            {"title": "Crear un usuario nuevo",
             ...
             "steps": [
                ("Entrá a Usuarios y tocá “Nuevo Usuario”.", "Ruta <span class='pill'>/dashboard/usuarios</span>."),
                ("Completá nombre, apellido, correo y contraseña.", "La contraseña tiene mínimo 6 caracteres y se guarda cifrada."),
                ("Asignale un rol.", "Solo podés asignar roles de nivel inferior al tuyo."),
                ("Guardá.", "El usuario ya puede entrar con su correo y contraseña."),
             ],
             "callouts": [("warn", "Jerarquía", "No podés crear ni editar a alguien de tu mismo nivel o superior. Un gerente no puede tocar a un OWNER.")]},
            {"title": "Asignar PIN y permisos a un usuario",
             ...
             "steps": [
                ("Abrí el usuario en Usuarios.", "Vas a ver sus secciones de módulos, PIN y permisos."),
                ("Asignale un PIN numérico de 4 a 6 dígitos.", "Queda como “Asignado”. El usuario no puede cambiar su propio PIN desde aquí."),
                ("Ajustá permisos si hace falta.", "Las casillas muestran tres estados: base (gris), concedido (verde) o revocado (rojo)."),
             ],
            ...
            {"title": "Ver finanzas y exportar",
             ...
             "steps": [
                ("Entrá a Dashboard Financiero y elegí mes y año.", "Ruta <span class='pill'>/dashboard/finanzas</span>."),
                ("Revisá el P&L, el flujo de caja y las alertas.", "Incluye comparación contra el mes anterior."),
                ("Tocá “Exportar Excel”.", "Descarga el P&L completo para compartir o archivar."),
             ]},
            {"title": "Sacar el Reporte Z del día",
             "intro": "El Reporte Z es el cierre de ventas agrupado por método de pago: la base del arqueo.",
             "steps": [
                ("Entrá a Historial de Ventas y elegí la fecha.", "Ruta <span class='pill'>/dashboard/sales</span>."),
                ("Abrí el Reporte Z.", "Agrupa por método, calcula Bs y USD, servicio, descuentos y anulaciones."),
                ("Usá el arqueo para exportar a Excel.", "Sirve para cuadrar contra el efectivo y los puntos de venta."),
             ]},
        ],
    ...
    # --------------------------------------------------------- OPS_MANAGER
    {
        ...
        "tasks": [
            {"title": "Llevar el inventario diario",
             ...
             "steps": [
                ("Abrí el día en Inventario Diario.", "Ruta <span class='pill'>/dashboard/inventario/diario</span>, elegí fecha y área."),
                ("Contá los ítems y guardá las cantidades.", "El conteo físico de cada insumo."),
                ("Sincronizá las ventas del POS.", "El sistema descuenta lo vendido para calcular el stock teórico."),
                ("Revisá teórico vs real y cerrá.", "La diferencia es la varianza (merma o faltante); al cerrar queda registrada."),
             ]},
            ...
            {"title": "Registrar entrada de mercancía",
             ...
             "steps": [
                ("Entrá a Inventario → Entrada de mercancía.", "Ruta <span class='pill'>/dashboard/inventario/entrada</span>."),
                ("Cargá los ítems recibidos y sus cantidades.", "Genera un movimiento de compra y actualiza el costo del insumo."),
             ]},
        ],
    ...
    # ---------------------------------------------------------- HR_MANAGER
    {
        "code": "HR_MANAGER", "level": 60, "name": "Gerente de RRHH", "kicker": "Recursos humanos",
        "tagline": "Gestiona el personal de salón (mesoneros)",
        "desc": "Se encarga del personal de piso: da de alta mesoneros, los activa o desactiva y "
                "define quién es capitán. Su alcance es acotado y muy específico.",
        "chips": [("Mesoneros", True), ("Usuarios", True)],
        "day": "Mantiene actualizada la lista de mesoneros: agrega a los nuevos, marca capitanes y "
               "desactiva a quienes ya no trabajan.",
        "tasks": [
            {"title": "Dar de alta y gestionar mesoneros",
             "intro": "El módulo de Mesoneros es la lista del personal de salón que aparece en el POS Mesero.",
             "steps": [
                ("Entrá a Mesoneros.", "Ruta <span class='pill'>/dashboard/mesoneros</span>."),
                ("Agregá un mesonero con su nombre.", "Queda disponible para identificarse en el POS Mesero."),
                ("Marcá si es capitán.", "El capitán puede dividir cuentas y transferir mesas."),
                ("Activá o desactivá según corresponda.", "Un mesonero inactivo deja de aparecer en la lista del POS."),
             ],
             "callouts": [("warn", "Importante", "RRHH gestiona a los mesoneros, pero <strong>no asigna sus PIN</strong>. Eso lo hace el OWNER, el Gerente Administrativo o el de Operaciones.")]},
        ],
        "can": ["Crear y editar mesoneros", "Activar / desactivar mesoneros", "Marcar capitanes"],
        "cant": ["Asignar PIN de mesonero", "Entrar a operaciones, POS o finanzas", "Gestionar otros roles"],
    },
    # --------------------------------------------------------------- CHEF
    {
        ...
        "tasks": [
            {"title": "Crear una receta",
             ...
             "steps": [
                ("Entrá a Recetas → Nueva.", "Ruta <span class='pill'>/dashboard/recetas/nueva</span>."),
                ("Agregá los ingredientes y sus cantidades.", "El sistema suma el costo de cada uno automáticamente."),
                ("Guardá.", "La receta queda disponible para producir y para vincular a un producto del menú."),
             ],
             "callouts": [("info", "Costo automático", "Si un ingrediente tiene su propia receta, el sistema lo costea recursivamente: nunca tenés que calcular a mano.")]},
            {"title": "Hacer una producción",
             "intro": "Producir una receta descuenta los ingredientes del stock y suma el producto terminado.",
             "steps": [
                ("Entrá a Producción y elegí la receta.", "Ruta <span class='pill'>/dashboard/produccion</span>."),
                ("Indicá la cantidad a producir.", "El sistema verifica que haya ingredientes suficientes."),
                ("Confirmá.", "Descuenta los insumos y suma el resultado al inventario."),
             ]},
        ],
    ...
    # ---------------------------------------------------------- AREA_LEAD
    {
        ...
        "tasks": [
            {"title": "Aprobar transferencias de su área",
             ...
             "steps": [
                ("Revisá las transferencias pendientes.", "En el módulo Transferencias."),
                ("Confirmá las cantidades recibidas o despachadas.", "Tu aprobación mueve el stock entre áreas."),
             ]},
            {"title": "Operar el POS Restaurante",
             "intro": "Si tu usuario tiene el módulo asignado, podés trabajar el POS completo: mesas, pedidos y cobro.",
             "steps": [
                ("Entrá a POS Restaurante.", "Ruta <span class='pill'>/dashboard/pos/restaurante</span>."),
                ("Operá como punto de venta.", "Seguí el flujo de mesa, pedido y cobro descrito en la sección de Cajera."),
             ]},
        ],
    ...
    # ------------------------------------------------------- KITCHEN_CHEF
    {
        ...
        "tasks": [
            {"title": "Ver y despachar comandas",
             ...
             "steps": [
                ("Abrí la comandera.", "Cocina en <span class='pill'>/kitchen</span>, barra en <span class='pill'>/kitchen/barra</span>. Es pantalla completa, sin menú lateral."),
                ("Mirá las comandas pendientes.", "Llegan automáticamente; no hace falta recargar."),
                ("Marcá la comanda como lista al terminar.", "Desaparece de pendientes; el salón sabe que el plato salió."),
             ],
    ...
    # ------------------------------------------------------------ CASHIER
    {
        ...
        "tasks": [
            {"title": "Abrir la caja al empezar el turno",
             ...
             "steps": [
                ("Entrá a Control de Caja y abrí la caja.", "Ruta <span class='pill'>/dashboard/caja</span>."),
                ("Cargá el fondo inicial en USD y Bs.", "Con desglose de billetes, para un cuadre exacto."),
                ("Confirmá las operadoras del turno.", "Queda registrado quién opera la caja."),
             ]},
            {"title": "Cobrar una cuenta de mesa",
             "intro": "El flujo va de elegir la mesa a registrar el pago. Podés cobrar con un método o combinar varios (pago mixto).",
             "mock": ("POS Restaurante — cobro", [
                 [("Cash $", False), ("Zelle", False), ("Efectivo Bs", False)],
                 [("PDV", False), ("Pago Móvil", False), ("Cobrar", True)],
             ]),
             "steps": [
                ("Abrí POS Restaurante y elegí la mesa o el pickup.", "Ruta <span class='pill'>/dashboard/pos/restaurante</span>."),
                ("Activá el +10% de servicio si corresponde.", "Suma 10% al total de la cuenta."),
                ("Elegí el método de pago.", "Uno solo, o pago mixto para combinar varios."),
                ("Registrá el pago y entregá el vuelto.", "El sistema muestra el vuelto a devolver bien destacado."),
                ("Cerrá la mesa.", "La cuenta queda saldada y la mesa se libera."),
             ],
             "callouts": [
            ...
            {"title": "Dividir una cuenta en subcuentas",
             ...
             "steps": [
                ("Tocá “÷ Dividir cuenta” en la mesa activa.", "Entra al modo de subcuentas."),
                ("Creá las subcuentas o usá la división rápida.", "Botones 2 / 3 / 4 / 5 / 6 reparten los ítems en partes iguales."),
                ("Asigná los ítems y cobrá cada subcuenta.", "Cada una con su método, su +10% y su monto."),
            ...
            {"title": "Imprimir la pre-cuenta",
             ...
             "steps": [
                ("Tocá el botón de Pre-cuenta en la mesa.", "Icono de impresora."),
                ("Entregá el impreso al cliente.", "Muestra el consumo real, sin descuentos de cobro."),
             ]},
            {"title": "Cerrar la caja al final del turno",
             ...
             "steps": [
                ("Entrá a Control de Caja y cerrá la caja.", "Hacé el conteo final de efectivo."),
                ("Revisá el cuadre.", "El sistema calcula lo esperado (fondo + ventas + propinas − gastos) y la diferencia."),
                ("Confirmá el cierre.", "Queda el registro del turno, con las propinas detalladas."),
             ]},
        ],
    ...
    # ------------------------------------------------------------- WAITER
    {
        ...
        "tasks": [
            {"title": "Identificarte con tu PIN",
             ...
             "steps": [
                ("Abrí el POS Mesero.", "Aparece el teclado numérico y la lista de mesoneros activos."),
                ("Ingresá tu PIN.", "El sistema te reconoce y carga tu nombre para el turno."),
             ],
            ...
            {"title": "Abrir una cuenta en una mesa",
             "intro": "Tocar una mesa libre abre la cuenta. Con datos mínimos ya podés empezar a cargar el pedido.",
             "steps": [
                ("Tocá una mesa libre.", "Se abre el cuadro “Abrir cuenta”."),
                ("Cargá el nombre y el número de personas.", "El nombre es opcional (por defecto “Cliente”)."),
                ("Confirmá “Abrir cuenta”.", "La mesa pasa a ocupada y ya podés agregar productos."),
             ]},
            {"title": "Agregar productos y enviar a cocina",
             ...
             "steps": [
                ("Seleccioná los productos del menú.", "Por categorías; elegí extras o modificadores si el producto los tiene."),
                ("Revisá el pedido en la cuenta.", "Verificá cantidades antes de enviar."),
                ("Enviá a cocina.", "Cada producto va a su estación: cocina o barra, según esté configurado."),
             ],
            ...
            {"title": "Mostrar la cuenta al cliente",
             ...
             "steps": [
                ("Tocá “Mostrar cuenta al cliente”.", "Muestra subtotal, servicio 10%, total en USD y el equivalente en Bs con la tasa."),
                ("Avisá a la caja para el cobro.", "El cobro y el cierre los hace la cajera, no el mesonero."),
             ]},
            {"title": "Dividir o transferir mesa (solo capitanes)",
             "intro": "Si sos capitán, podés dividir la cuenta en partes o transferir la mesa a otro mesonero.",
             "steps": [
                ("Usá “÷ Dividir cuenta” para separar el consumo.", "Solo visible para capitanes."),
                ("Usá “↔ Transferir mesa” para cambiar de mesonero.", "La transferencia pide PIN de capitán o de gerente."),
             ]},
        ],
...
FAQ = [
    ("¿Por qué no veo un módulo que un compañero sí ve?",
     ...
     "en tu lista personal. Si te falta, pedile al administrador que revise tus módulos asignados."),
    ("Olvidé mi contraseña, ¿qué hago?",
     "Pedile al OWNER o al Gerente Administrativo que te la resetee desde Usuarios. Nadie puede "
